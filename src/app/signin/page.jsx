    ...
    return (
        <div class="relative flex flex-col h-full lg:py-10 overflow-hidden justify-center bg-neutral">
            <div class="w-full p-6 m-auto text-neutral-content lg:bg-neutral-focus lg:rounded-md lg:shadow-md lg:ring-2 lg:ring-gray-800/50 lg:max-w-xl">
                <h1 class="text-3xl mb-1 font-semibold text-center">Sign In</h1>
                <form class="space-y-4">
                    ...
                    <div>
                        <button class="btn btn-block btn-primary mb-3">Sign In</button>
                    </div>
                    <span>Dont have an account yet? 
                        <Link href="/signup" class="text-blue-600 hover:text-blue-800 hover:underline"> Sign Up</Link></span>
                </form>
